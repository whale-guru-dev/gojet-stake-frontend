export default [
  {
    inputs: [{ internalType: 'address', name: '_GRO', type: 'address' }],
  ...
  {
    inputs: [],
    name: 'latestRewardedBlock',
    outputs: [{ internalType: 'uint256', name: '_block', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'rewardPerBlock',
    outputs: [{ internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_newExchange', type: 'address' }],
    name: 'setExchange',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newRewardPerBlock', type: 'uint256' }],
